...
//        System.out.println("接收到的数据:" + context);
        ...
        if (action == MsgActionEnum.CONNECT.type) {
            ...
            //保存消息到数据库,并且标记未  未签收
            //在handler中无法直接注入spring,所以需要借助spring的工具类,通过默认类名的驼峰形式获取
            ...
            if (receiverChannel == null) {
                ...
                //当receiverChannel不为空的时候,冲ChannelGroup去查找对应的channel是否存在
            ...
            System.out.println(msgIdList.toArray());
